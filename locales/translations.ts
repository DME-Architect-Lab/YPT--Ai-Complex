...
export const translations = {
    vi: {
        ...
        enterApiKeyPrompt: "Vui lòng nhập API Key của bạn:",
        alertApiKeyUtilUnavailable: "Tính năng chọn API Key không khả dụng.",
...
Kết quả: 01 ảnh texture vuông chất lượng cao, seamless và delighting.`,
    ...
    en: {
        ...
        enterApiKeyPrompt: "Please enter your API Key:",
